...
Fecha inicial: 9 de septiembre de 2026. **Actualización: 19 de septiembre de 2026 · Revisión 21.** Base revisada: `main`, commit `986dd79` (integración del PR #15, 14/09/2026).

**Situación:** el núcleo del viaje y del acceso está implementado; todavía no hay evidencia suficiente para abrir al público. F01 está completada localmente, F02 sigue en curso y F04 tiene una entrega parcial adelantada. F03 está planificada sin implementar; F05–F10 conservan sus cierres pendientes, aunque reutilizan mapas, tiempo real e infraestructura ya existentes.
...
La [presentación HTML](presentacion-salida-produccion.html) está sincronizada con esta revisión 21: resume las diez fases, la evidencia y las próximas entregas. Su vista «Plan completo» y su descarga contienen este documento íntegro.
...
| F05 | Seguimiento, mapas y notificaciones | F04. | Pendiente: reutiliza mapas/rutas y recuperación realtime existentes |
...
Los tres perfiles EAS, las identidades de aplicación y la validación de configuración existen. Desarrollo y Pruebas tienen evidencia histórica de recursos locales separados y APK instalados. Falta materializar y certificar la infraestructura alojada y todas sus integraciones; un perfil de build por sí solo no constituye un entorno aislado. Desarrollo continúa local; Pruebas temporal depende de la PC y del túnel, hasta su alojamiento estable en F09.
...
**Estado:** Pendiente de completar. Existen mapas, búsqueda de lugares, rutas y recuperación WebSocket; no se encontró el circuito de publicación GPS del conductor al pasajero ni push. **Responsable:** por asignar. **PR y evidencia del seguimiento completo:** por registrar.
...
- Desarrollo/pruebas: recorrer alta por teléfono, OTP posterior a Google y a cualquier proveedor social habilitado, y cambio de número con autocompletado, verificando cero llamadas al proveedor SMS tanto al enviar como al validar y reenviar. Desactivar autocompletado para comprobar códigos incorrectos, caducidad y uso único.
